        ...
        <div className="flex flex-col items-center gap-12 md:flex-row">
          ...
          <div className="flex-1">
            ...
            <p className="mb-8 text-lg leading-relaxed text-gray-600">
              부품 시장의 수급 상황과 신제품 출시 주기를 AI가 24시간 실시간 모니터링합니다.
              가장 합리적인 골든 타임에 도달했을 때 구매 타이머가 활성화됩니다.
            </p>

            <div className="flex flex-wrap gap-4">
              <div className="flex h-[120px] w-[160px] flex-col items-center rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
